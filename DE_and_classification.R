...
# Confusion table 
svmModle5.2 <- acc.dis.singleModle.2(DE.miRNA.CP.fs.expr2, 60, 53)
roc.plot3(DE.miRNA.CP.fs.expr2, 60, 53, "C.P.miRNA", r=200, svmModle5.2)

acc_results.CP <- acc.dis.singleModle(DE.miRNA.CP.fs.expr2, 60, 53, info = TRUE)
...
svmModle4.2 <- acc.dis.singleModle.2(DE.miRNA.C.R.fs.expr4, 60, 56)
roc.plot3(DE.miRNA.C.R.fs.expr4, 60, 56, "C.R.miRNA.3", r=100, svmModle4.2)

acc_results.CR <- acc.dis.singleModle(DE.miRNA.C.R.fs.expr4, 60, 56, info = TRUE)
# train
...
svmModle6.2 <- acc.dis.singleModle.2(DE.miRNA.RP.fs.expr2, 56, 53)
roc.plot3(DE.miRNA.RP.fs.expr2, 56, 53, "R.P.miRNA", r=200, svmModle6.2)

acc_results.RP <- acc.dis.singleModle(DE.miRNA.RP.fs.expr2, 56, 53, info = TRUE)
